...
public interface ProductRepository extends JpaRepository<Product, Long> {
	...
	List<ProductMinProjection> buscaPorQuantidadeLetraInicial(Integer min, Integer max, String beginName);
	...
	List<ProductMinDTO> jpqlBuscaPorQuantidadeLetraInicial(Integer min, Integer max, String beginName);
}
