...
public interface MovieRepository extends JpaRepository<Movie, Long> {
	...
	List<MovieMinProjection> encontrarFilmesPeloGenero(String genreName);
	
	//JPQL não precisa projection
	...
	List<MovieMinDTO> jpqlEncontrarFilmesPeloGenero(String genreName);
